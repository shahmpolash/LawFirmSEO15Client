...
const EditFeaturesServicesText = () => {
    ...
    useEffect(() => {
        fetch(`https://legelserviceseo15-4512b38069b4.herokuapp.com/featurestext/${id}`)
            .then((res) => res.json())
    ...
    const handleFeaturesTextSection = (event) => {
        ...
        const url = `https://legelserviceseo15-4512b38069b4.herokuapp.com/featurestext/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
                        ...
                        <form class="contact-form " onSubmit={handleFeaturesTextSection}>
                            <div class="row">
                                ...
                                <div class="slider-btn">
                                    <button class="btn btn-primary mb-5" data-animation="fadeInRight" data-delay=".8s"> Update Features Text </button>
                                </div>
                            </div>
