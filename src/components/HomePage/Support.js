...
const Support = () => {
  ...
  useEffect(() => {
    fetch(`https://legelserviceseo15-4512b38069b4.herokuapp.com/contacts`)
      .then((res) => res.json())
            ...
            <div className="contact-from">
              ...
              <form action="#" onSubmit={handleMessage}>
                <div className="row">
                  ...
                  <div className="col-12">
                    <button className="btn btn-primary mb-5 w-100">Send Message</button>
                  </div>
                </div>
              </form>
            </div>
...

              {
                action.map(a => <div className="col-lg-7 col-md-10">
                  <div className="cta-content">
                    ...
                    <a href={a.buttonLink} className="btn btn-primary mb-5">{a.buttonText}<i className="far fa-long-arrow-right" /></a>
                  </div>
                </div>)
              }
