...
const AddProduct = () => {
  ...
  useEffect(() => {
    fetch(`https://legelserviceseo15-4512b38069b4.herokuapp.com/products-variation`)
      .then((res) => res.json())
      .then((info) => setVariations(info));
  }, []);
  useEffect(() => {
    fetch(`https://legelserviceseo15-4512b38069b4.herokuapp.com/categories`)
      .then((res) => res.json())
  ...
  const handleAddProduct = (event) => {
    ...
    const url = `https://legelserviceseo15-4512b38069b4.herokuapp.com/add-product`;
    fetch(url, {
      method: "POST",
      headers: {
