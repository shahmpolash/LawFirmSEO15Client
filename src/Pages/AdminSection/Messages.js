...
const Messages = () => {
    ...
    useEffect(() => {
        fetch(`https://legelserviceseo15-4512b38069b4.herokuapp.com/messages`)
            .then((res) => res.json())
            ...
            <tbody>
                {currentMessages.map((message, index) => (
                    <tr key={message._id}>
                        ...
                        <td>
                            <Link to={`/view/${message._id}`} className="btn btn-primary mb-5" data-animation="fadeInRight" data-delay=".8s">
                                View Message
                            </Link>
                        </td>
                    </tr>
