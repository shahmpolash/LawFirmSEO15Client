...
const FooterContact = () => {
    ...
    const handlefooterAddress = (event) => {
        ...
        const url = `https://legelserviceseo15-4512b38069b4.herokuapp.com/add-footer-address`;
        fetch(url, {
            method: "POST",
            headers: {
                                ...
                                <>
                                    {
                                        footeraddress.map(c =>
                                            footeraddress.map(c =>
                                                <Link className='btn btn-primary mb-5' to={`/edit-address-footer/${c._id}`}> Edit Address</Link>)
                                ...
                                <form class="contact-form " onSubmit={handlefooterAddress}>
                                    <div class="row">
                                        ...
                                        <div class="slider-btn">
                                            <button class="btn btn-primary mb-5" data-delay=".8s"> Add Office Address</button>
                                        </div>
                                    </div>
