...
const UpdateUser = () => {
    ...
    useEffect(() => {
        fetch(`https://legelserviceseo15-4512b38069b4.herokuapp.com/users/${id}`)
            .then((res) => res.json())
    ...
    const handleUser = (event) => {
        ...
        const url = `https://legelserviceseo15-4512b38069b4.herokuapp.com/upadete-users/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="slider-btn ">
                                        <button class="btn btn-primary mb-5" data-animation="fadeInRight" data-delay=".8s"> Update User Email </button>
