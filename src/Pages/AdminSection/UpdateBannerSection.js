...
const UpdateBannerSection = () => {
    ...
    useEffect(() => {
        fetch(`https://legelserviceseo15-4512b38069b4.herokuapp.com/banner/${id}`)
            .then((res) => res.json())
    ...
    const handleBannerSection = (event) => {
        ...
        const url = `https://legelserviceseo15-4512b38069b4.herokuapp.com/update-banner/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
                                ...
                                <form class="contact-form " onSubmit={handleBannerSection}>
                                    <div class="row">
                                        ...
                                        <div class="slider-btn">
                                            <button class="btn btn-primary " data-animation="fadeInRight" data-delay=".8s">Update Banner</button>
                                        </div>
                                    </div>
