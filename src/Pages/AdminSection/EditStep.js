...
const EditStep = () => {
    ...
    useEffect(() => {
        fetch(`https://legelserviceseo15-4512b38069b4.herokuapp.com/step-item/${id}`)
            .then((res) => res.json())
    ...
    const handleStepSection = (event) => {
        ...
        const url = `https://legelserviceseo15-4512b38069b4.herokuapp.com/step-item/${step._id}`;
        fetch(url, {
            method: "PUT",
            headers: {
                            ...
                            <form class="contact-form " onSubmit={handleStepSection}>
                                <div class="row">
                                    ...
                                    <div class="slider-btn">
                                        <button class="btn btn-primary mb-5" data-animation="fadeInRight" data-delay=".8s"> Update Step </button>
                                    </div>
                                </div>
