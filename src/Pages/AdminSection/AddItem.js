...
const AddItem = () => {
    ...
    const handleAddItem = (event) => {
        ...
        const url = `https://legelserviceseo15-4512b38069b4.herokuapp.com/add-item`;
        fetch(url, {
            method: "POST",
            headers: {
                            ...
                            <form class="contact-form " onSubmit={handleAddItem}>
                                <div class="row">
                                    ...
                                    <div class="slider-btn">
                                        <button class="btn btn-primary mb-5" data-animation="fadeInRight" data-delay=".8s">Add Item</button>
                                    </div>
                                </div>
