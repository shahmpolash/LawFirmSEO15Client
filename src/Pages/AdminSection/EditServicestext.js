...
const EditServicestext = () => {
    ...
    useEffect(() => {
        fetch(`https://legelserviceseo15-4512b38069b4.herokuapp.com/service/${id}`)
            .then((res) => res.json())
    ...
    const handleServiceText = (event) => {
        ...
        const url = `https://legelserviceseo15-4512b38069b4.herokuapp.com/service/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
                                    ...
                                    <div class="row">
                                        ...
                                        <div className="col-lg-12 col-md-12 mb-3">
                                         ...
                                         <div class="slider-btn">
                                            <button class="btn btn-primary mb-5" data-animation="fadeInRight" data-delay=".8s"> Update Services Text</button>
                                        </div>
                                    </div>
