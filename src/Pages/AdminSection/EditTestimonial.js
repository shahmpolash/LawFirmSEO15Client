...
const EditTestimonial = () => {
    ...
    useEffect(() => {
        fetch(`https://legelserviceseo15-4512b38069b4.herokuapp.com/testimonial/${id}`)
            .then((res) => res.json())
    ...
    const handleTestimonialSection = (event) => {
        ...
        const url = `https://legelserviceseo15-4512b38069b4.herokuapp.com/testimonial/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
                                ...
                                <form class="contact-form " onSubmit={handleTestimonialSection}>
                                    <div class="row">
                                        ...
                                        <div class="slider-btn">
                                            <button class="btn btn-primary mb-5" data-animation="fadeInRight" data-delay=".8s"> Update Testimonial </button>
                                        </div>
                                    </div>
