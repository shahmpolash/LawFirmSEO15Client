...
const Pricing = () => {
    ...
    const handlePricing = (event) => {
        ...
        const url = `https://legelserviceseo15-4512b38069b4.herokuapp.com/add-pricing`;
        fetch(url, {
            method: "POST",
            headers: {
                                ...
                                {/* <form class="contact-form " onSubmit={handlePricing}>
                                    <div class="row">
                                        ...
                                        <div class="slider-btn">
                                            <button class="btn btn-primary mb-5" data-delay=".8s"> Add Package</button>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="pricingTable">
                                        ...
                                        <div class="pricingTable-signup">
                                            <Link to={`/package-edit/${pri._id}`} className='btn btn-primary mb-5'>Edit Pricing</Link>
                                        </div>
                                    </div>
                                </div>
                            )}
