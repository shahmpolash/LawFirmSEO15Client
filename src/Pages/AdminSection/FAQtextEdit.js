...
const FAQtextEdit = () => {
    ...
    useEffect(() => {
        fetch(`https://legelserviceseo15-4512b38069b4.herokuapp.com/faq/${id}`)
            .then((res) => res.json())
    ...
    const handleFAQText = (event) => {
        ...
        const url = `https://legelserviceseo15-4512b38069b4.herokuapp.com/faq/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
                                ...
                                <form class="contact-form " onSubmit={handleFAQText}>
                                    <div class="row">
                                        ...
                                        <div class="slider-btn">
                                            <button class="btn btn-primary mb-5" data-animation="fadeInRight" data-delay=".8s"> Update FAQ Text </button>
                                        </div>
                                    </div>
