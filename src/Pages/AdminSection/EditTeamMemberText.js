...
const EditTeamMemberText = () => {
    ...
    useEffect(() => {
        fetch(`https://legelserviceseo15-4512b38069b4.herokuapp.com/teamstext/${id}`)
            .then((res) => res.json())
    ...
    const handleTeamTextSection = (event) => {
        ...
        const url = `https://legelserviceseo15-4512b38069b4.herokuapp.com/teamstext/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
                        ...
                        <form class="contact-form " onSubmit={handleTeamTextSection}>
                            <div class="row">
                                ...
                                <div class="slider-btn">
                                    <button class="btn btn-primary mb-5" data-animation="fadeInRight" data-delay=".8s"> Update Team Member Text </button>
                                </div>
                            </div>
