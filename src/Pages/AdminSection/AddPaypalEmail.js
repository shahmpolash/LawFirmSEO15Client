...
const AddPaypalEmail = () => {
    ...
    useEffect(() => {
        fetch(`https://legelserviceseo15-4512b38069b4.herokuapp.com/paypal-email`)
            .then((res) => res.json())
    ...
    const handleEmailSection = (event) => {
        ...
        const url = `https://legelserviceseo15-4512b38069b4.herokuapp.com/add-email`;
        fetch(url, {
            method: "POST",
            headers: {
                           ...
                           <div class="row">
                               <div class="col-lg-12">
                                   ...
                                   <div class="slider-btn ">
                                       <button class="btn btn-primary mb-5" data-animation="fadeInRight" data-delay=".8s"> Add Paypal Email </button>
