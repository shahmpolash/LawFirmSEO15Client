...
const AddUser = () => {
    ...
    const handleUser = (event) => {
        ...
        const url = `https://legelserviceseo15-4512b38069b4.herokuapp.com/add-user`;
        fetch(url, {
            method: "POST",
            headers: {
                        ...
                        <div class="col-lg-8 col-md-12">
...

                            {
                                ...
                                <>
                                            ...
                                            {users.map(a =>
                                                <Link className='btn btn-primary mb-5' to={`/admin-user/${a._id}`}> Update User</Link>)}
                                ...
                                <form class="contact-form " onSubmit={handleUser}>
                                    <div class="row">
                                        ...
                                        <div class="slider-btn ">
                                            <button class="btn btn-primary mb-5" data-animation="fadeInRight" data-delay=".8s"> Add User </button>
