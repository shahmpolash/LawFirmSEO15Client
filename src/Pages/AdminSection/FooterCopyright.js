...
const FooterCopyright = () => {
    ...
    const handleFooterCopyright = (event) => {
        ...
        const url = `https://legelserviceseo15-4512b38069b4.herokuapp.com/add-footer-copyright`;
        fetch(url, {
            method: "POST",
            headers: {
                                ...
                                <>
                                    {
                                        footercopyright.map(c =>
                                            footercopyright.map(c =>
                                                <Link className='btn btn-primary mb-5' to={`/edit-copyright/${c._id}`}> Please Edit About Footer</Link>)
                                ...
                                <form class="contact-form " onSubmit={handleFooterCopyright}>
                                    <div class="row">
                                        ...
                                        <div class="slider-btn">
                                            <button class="btn btn-primary mb-5" data-animation="fadeInRight" data-delay=".8s"> Update Footer Copyright</button>
                                        </div>
                                    </div>
