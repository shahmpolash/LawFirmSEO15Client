...
const FooterSocial = () => {
    ...
    const handleFootersocial = (event) => {
        ...
        const url = `https://legelserviceseo15-4512b38069b4.herokuapp.com/add-footer-social`;
        fetch(url, {
            method: "POST",
            headers: {
                                ...
                                <>
                                    {
                                        footersocial.map(c =>
                                            footersocial.map(c =>
                                                <Link className='btn btn-primary mb-5' to={`/edit-social-footer/${c._id}`}> Edit Social URL </Link>)
                                ...
                                <form class="contact-form " onSubmit={handleFootersocial}>
                                    <div class="row">
                                        ...
                                        <div class="slider-btn">
                                            <button class="btn btn-primary mb-5" data-delay=".8s"> Add Footer Social </button>
                                        </div>
                                    </div>
