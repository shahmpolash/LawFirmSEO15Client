...
const PaypalEmail = () => {
    ...
    useEffect(() => {
        fetch(`https://legelserviceseo15-4512b38069b4.herokuapp.com/paypal-email/${id}`)
            .then((res) => res.json())
    ...
    const handleUpdatePaypal = (event) => {
        ...
        const url = `https://legelserviceseo15-4512b38069b4.herokuapp.com/paypal-email/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
                            ...
                            <form class="contact-form " onSubmit={handleUpdatePaypal}>
                                <div class="row">
                                    ...
                                    <div class="slider-btn">
                                        <button class="btn btn-primary mb-5" data-animation="fadeInRight" data-delay=".8s"> Update Now</button>
                                    </div>
                                </div>
