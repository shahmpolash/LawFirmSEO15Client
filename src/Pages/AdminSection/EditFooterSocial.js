...
const EditFooterSocial = () => {
    ...
    useEffect(() => {
        fetch(`https://legelserviceseo15-4512b38069b4.herokuapp.com/footer-social/${id}`)
            .then((res) => res.json())
    ...
    const handleFootersocial = (event) => {
        ...
        const url = `https://legelserviceseo15-4512b38069b4.herokuapp.com/footer-social/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
                            ...
                            <form class="contact-form " onSubmit={handleFootersocial}>
                                <div class="row">
                                    ...
                                    <div class="slider-btn">
                                        <button class="btn btn-primary mb-5" data-delay=".8s"> Update Footer</button>
                                    </div>
                                </div>
