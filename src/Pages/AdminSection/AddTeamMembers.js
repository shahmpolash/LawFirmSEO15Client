...
const AddTeamMembers = () => {
    ...
    useEffect(() => {
        fetch(`https://legelserviceseo15-4512b38069b4.herokuapp.com/teamstext`)
            .then((res) => res.json())
            .then((info) => setTeamText(info));
    }, []);

    useEffect(() => {
        fetch(`https://legelserviceseo15-4512b38069b4.herokuapp.com/teamitems`)
            .then((res) => res.json())
    ...
    const handleTeamTextSection = (event) => {
        ...
        const url = `https://legelserviceseo15-4512b38069b4.herokuapp.com/add-teammember-text`;
        fetch(url, {
            method: "POST",
            headers: {
    ...
    const handleMembersItemSection = (event) => {
        ...
        const url = `https://legelserviceseo15-4512b38069b4.herokuapp.com/add-team-Item`;
        fetch(url, {
            method: "POST",
            headers: {
                "content-type": "application/json",
                                ...
                                <form class="contact-form " onSubmit={handleMembersItemSection}>
                                    <div class="row">
                                        ...
                                        <div class="slider-btn">
                                            <button class="btn btn-primary mb-5" data-delay=".8s"> Add Member Item</button>
                                        </div>
                                    </div>
                                ...
                                <div className="row slider-shadow th-carousel teamSlide1" id="teamSlide1" data-slide-show={4} data-lg-slide-show={3} data-md-slide-show={2} data-sm-slide-show={2} data-xs-slide-show={1} data-arrows="true">
                                    {
                                        teamitems.map(m => <div className="col-sm-6 col-lg-4 col-xxl-3">
                                            <div className="th-team team-box wow fadeInUp">
                                                ...
                                                <Link to={`/edit-team-items/${m._id}`}><h3 className="box-title " class="btn btn-primary mb-5 mb-3">Edit Now</h3></Link>
