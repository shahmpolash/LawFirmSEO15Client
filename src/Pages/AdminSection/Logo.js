...
const Logo = () => {
    ...
    const handleLogo = (event) => {
        ...
        const url = `https://legelserviceseo15-4512b38069b4.herokuapp.com/add-logo`;
        fetch(url, {
            method: "POST",
            headers: {
                                ...
                                <>
                                    {
                                        logo.map(c =>
                                            logo.map(c =>
                                                <Link className='btn btn-primary mb-5' to={`/edit-logo/${c._id}`}> Please Edit Your Logo</Link>)
                                ...
                                <form class="contact-form " onSubmit={handleLogo}>
                                    ...
                                    <div className="col-lg-12 col-md-12 mb-3">
                                        ...
                                        <div class="slider-btn">
                                            <button class="btn btn-primary mb-5" data-animation="fadeInRight" data-delay=".8s">Update Your Logo</button>
                                        </div>
                                    </div>
