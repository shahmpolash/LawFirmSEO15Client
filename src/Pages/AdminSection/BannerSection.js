...
const BannerSection = () => {
    ...
    const handleBannerSection = (event) => {
        ...
        const url = `https://legelserviceseo15-4512b38069b4.herokuapp.com/add-banner`;
        fetch(url, {
            method: "POST",
            headers: {
                                    ...
                                    <>
                                        {
                                            banner.map(c =>
                                                banner.map(c =>
                                                    <Link className='btn btn-primary mb-5' to={`/banner/${c._id}`}> Edit Banner Section</Link>)
                                            )
                                        }
                                    </>
                                }
                                    ...
                                    <form class="contact-form " onSubmit={handleBannerSection}>
                                        <div class="row">
                                            ...
                                            <div class="slider-btn">
                                                <button class="btn btn-primary mb-5" data-animation="fadeInRight" data-delay=".8s">Add Banner</button>
                                            </div>
                                        </div>
