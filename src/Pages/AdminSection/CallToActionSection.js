...
const CallToActionSection = () => {
    ...
    const handleActionSection = (event) => {
        ...
        const url = `https://legelserviceseo15-4512b38069b4.herokuapp.com/add-action`;
        fetch(url, {
            method: "POST",
            headers: {
                                    ...
                                    <>
                                        {
                                            ...
                                            action.map(c =>
                                                <Link className='btn btn-primary mb-5' to={`/edit-call/${c._id}`}> Edit Call To Action</Link>)
                                    ...
                                    <form class="contact-form " onSubmit={handleActionSection}>
                                        <div class="row">
                                            ...
                                            <div class="slider-btn mb-3">
                                                <button class="btn btn-primary mb-5" data-animation="fadeInRight" data-delay=".8s">Add Call To Action</button>
                                            </div>
                                        </div>
