...
const EditFooterabout = () => {
    ...
    useEffect(() => {
        fetch(`https://legelserviceseo15-4512b38069b4.herokuapp.com/footer-about/${id}`)
            .then((res) => res.json())
    ...
    const handleFooterAbout = (event) => {
        ...
        const url = `https://legelserviceseo15-4512b38069b4.herokuapp.com/footer-about/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
                            ...
                            <form class="contact-form " onSubmit={handleFooterAbout}>
                                <div class="row">
                                    ...
                                    <div class="slider-btn">
                                        <button class="btn btn-primary mb-5" data-animation="fadeInRight" data-delay=".8s"> Update Footer About</button>
                                    </div>
                                </div>
