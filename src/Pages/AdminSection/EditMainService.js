...
const EditMainService = () => {
    ...
    useEffect(() => {
        fetch(`https://legelserviceseo15-4512b38069b4.herokuapp.com/service-item/${id}`)
            .then((res) => res.json())
    ...
    const handleAddItem = (event) => {
        ...
        const url = `https://legelserviceseo15-4512b38069b4.herokuapp.com/service-item/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
            ...
            <form class="contact-form" onSubmit={handleAddItem}>
                <div class="row">
                    ...
                    <div class="slider-btn">
                        <button class="btn btn-primary mb-5" data-animation="fadeInRight" data-delay=".8s"> Update Main service </button>
                    </div>
                </div>
