...
const ServicesSection = () => {
    ...
    const handleServiceSection = (event) => {
        ...
        const url = `https://legelserviceseo15-4512b38069b4.herokuapp.com/add-Service`;
        fetch(url, {
            method: "POST",
            headers: {
    ...
    const handleAddItem = (event) => {
        ...
        const url = `https://legelserviceseo15-4512b38069b4.herokuapp.com/add-service-item`;
        fetch(url, {
            method: "POST",
            headers: {
                "content-type": "application/json",
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-12">
                            <h2 className='mt-5'> Update Service Text </h2>
                            {
                                service.length === 1 &&
                                <> {
                                    service.map(s => <Link className='btn btn-primary mb-5' to={`/servicetext-edit/${s._id}`}>Update Service</Link>)
                                }</>
                                ...
                                <form class="contact-form " onSubmit={handleServiceSection}>
                                    <div class="row">
                                        ...
                                        <div class="slider-btn">
                                            <button class="btn btn-primary mb-5" data-animation="fadeInRight" data-delay=".8s"> Update Services </button>
                                        </div>
                                    </div>
                            ...
                            {/* <form class="contact-form" onSubmit={handleAddItem}>
                                <div class="row">
                                    ...
                                    <div class="slider-btn">
                                        <button class="btn btn-primary mb-5" data-animation="fadeInRight" data-delay=".8s"> Add Service </button>
                                    </div>
                                </div>
        ...
        <div className="course_card style_2">
          ...
          <div className="item_content">
            ...
            <h3 className="item_title">
              ...
              <Link to={`/service-edit/${s._id}`} className='btn btn-primary mb-5  mt-2 mb-2'>Edit Services</Link>
              </a>
            </h3>
