...
const EditVideoText = () => {
    ...
    useEffect(() => {
        fetch(`https://legelserviceseo15-4512b38069b4.herokuapp.com/videos/${id}`)
            .then((res) => res.json())
    ...
    const handleVideoText = (event) => {
        ...
        const url = `https://legelserviceseo15-4512b38069b4.herokuapp.com/update-videos/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
                                ...
                                <form class="contact-form " onSubmit={handleVideoText}>
                                    <div class="row">
                                        ...
                                        <div class="slider-btn">
                                            <button class="btn btn-primary mb-5" data-animation="fadeInRight" data-delay=".8s"> Update Video Text</button>
                                        </div>
                                    </div>
