...
const EditFooterContact = () => {
    ...
    useEffect(() => {
        fetch(`https://legelserviceseo15-4512b38069b4.herokuapp.com/footer-address/${id}`)
            .then((res) => res.json())
    ...
    const handlefooterAddress = (event) => {
        ...
        const url = `https://legelserviceseo15-4512b38069b4.herokuapp.com/footer-address/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
                            ...
                            <form class="contact-form " onSubmit={handlefooterAddress}>
                                <div class="row">
                                    ...
                                    <div class="slider-btn">
                                        <button class="btn btn-primary mb-5" data-delay=".8s"> Update Address Details</button>
                                    </div>
                                </div>
