...
const AddTestimonial = () => {
    ...
    const handleTestimonialSection = (event) => {
        ...
        const url = `https://legelserviceseo15-4512b38069b4.herokuapp.com/add-testimonial-text`;
        fetch(url, {
            method: "POST",
            headers: {
    ...
    const handleStepSection = (event) => {
        ...
        const url = `https://legelserviceseo15-4512b38069b4.herokuapp.com/add-testimonial`;
        fetch(url, {
            method: "POST",
            headers: {
                "content-type": "application/json",
    ...
    return (
        ...
        <div className='mt-5'>
                    ...
                    <div class="col-lg-8 col-md-12">
                        ...
                        <h3 className='mb-5'> Update Testimonial Text </h3>
                        {
                            ...
                            <>
                                {testimonialtext.map(text =>
                                    <Link className='btn btn-primary mb-5' to={`/testimonialtext-edit/${text._id}`}> Update Now</Link>
                                )}
                            </>
                        }
                            ...
                            <form class="contact-form " onSubmit={handleTestimonialSection}>
                                <div class="row">
                                    ...
                                    <div class="slider-btn">
                                        <button class="btn btn-primary mb-5" data-animation="fadeInRight" data-delay=".8s"> Update Testimonial Text </button>
                                    </div>
                                </div>
                        ...
                        {/* <form class="contact-form " onSubmit={handleStepSection}>
                            <div class="row">
                                ...
                                <div class="slider-btn">
                                    <button class="btn btn-primary mb-5" data-delay=".8s"> Add Testimonial</button>
                                </div>
                            </div>
            ...
            <div className="container">
                ...
                <h3 className='mt-5 mb-5'>Edit Your Testimonial</h3>
                {
