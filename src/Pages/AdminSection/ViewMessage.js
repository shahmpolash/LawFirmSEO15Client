...
const ViewMessage = () => {
    ...
    useEffect(() => {
        fetch(`https://legelserviceseo15-4512b38069b4.herokuapp.com/message/${id}`)
            .then((res) => res.json())
    ...
    const handleMessage = (event) => {
        ...
        const url = `https://legelserviceseo15-4512b38069b4.herokuapp.com/message/${message._id}`;
        fetch(url, {
            method: "PUT",
            headers: {
                ...
                <div class="container">
                    ...
                    </div>
                    {
                        ...
                        <form onSubmit={handleMessage}>
                            ...
                            <input className='btn btn-primary mb-5 mt-5' type='submit' value='Mark Read'></input>
