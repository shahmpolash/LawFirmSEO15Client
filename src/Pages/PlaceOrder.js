...
const PlaceOrder = () => {
  ...
  useEffect(() => {
    fetch(`https://legelserviceseo15-4512b38069b4.herokuapp.com/cash-on-delivery`)
      .then((res) => res.json())
      .then((info) => setCash(info));
  }, []);

  useEffect(() => {
    fetch(`https://legelserviceseo15-4512b38069b4.herokuapp.com/product/${id}`)
      .then((res) => res.json())
  ...
  useEffect(() => {
    fetch(`https://legelserviceseo15-4512b38069b4.herokuapp.com/payment-accounts`)
      .then((res) => res.json())
  ...
  const handlePlaceOrder = (event) => {
    ...
    const url = `https://legelserviceseo15-4512b38069b4.herokuapp.com/new-order`;
    fetch(url, {
      method: "POST",
      headers: {
  ...
  const handlePlaceOrderCashOnDelivery = (event) => {
    ...
    const url = `https://legelserviceseo15-4512b38069b4.herokuapp.com/new-order-cash-on-delivery`;
    fetch(url, {
      method: "POST",
      headers: {
        "content-type": "application/json",
