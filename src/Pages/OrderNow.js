...
const OrderNow = () => {
    ...
    useEffect(() => {
        fetch(`https://legelserviceseo15-4512b38069b4.herokuapp.com/pricing/${id}`)
            .then((res) => res.json())
                        ...
                        <form class="contact-form mt-5" onSubmit={handleNewOrder}>
                            <div class="row">
                                    ...
                                    <div class="slider-btn">
                                        <button class="btn btn-primary mb-5" data-animation="fadeInRight" data-delay=".8s">Place Order Now</button>
                                    </div>
